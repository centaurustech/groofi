...
Router::connect('/admin/projects/:filter/*', array('controller' => 'projects', 'action' => 'index', 'admin' => true), array(
    'pass' => array('filter'),
    'filter' => 'all|proposals|rejected|approved|outstanding|leading|published|disabled|about-to-finish|finished|funded|not-funded|week|idioma_ita|idioma_eng|idioma_esp'
        )
);
...
Router::connect('/admin/offers/:filter/*', array('controller' => 'offers', 'action' => 'index', 'admin' => true), array(
    'pass' => array('filter'),
    'filter' => 'all|proposals|rejected|approved|outstanding|leading|published|disabled|about-to-finish|finished|week|idioma_ita|idioma_eng|idioma_esp'
        )
);
