...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            email: "<?echo __("EMAIL_GENERIC_ERROR");?>",
...
jQuery( document ).ready(function () {
    ...
    jQuery('.bot_enviar').click(function(){
...
<div class="contacto_left_container">
    ...
    <div class="texto_contacto_izq">
        <h3 class="cyan">Groofi Italy</h3>
        <br>
        Phone: +39 347 1201269<br>
        <span class="cyan">italy@groofi.com</span>
        </p>
    </div>
</div>
