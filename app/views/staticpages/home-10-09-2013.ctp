                    ...
                    createSlideHome(
                            [
                                ...
                                $informacion_proyecto ='<div class="tabla_proyectos"><div class="muestra2 texto_'.$_SESSION['idioma'].'">'.Project::getFundedValue($v).'%</div><div class="muestra2 texto1_'.$_SESSION['idioma'].'" >'.Project::getCollectedValue($v).'</div><div class="muestra2">'.$v["Project"]["sponsorships_count"].'</div></div>';
                                    ?>
                                '<div id="foto" style="background:url( <?=$img ?>) center center no-repeat"></div><div id="descripcion"><h2 style="color:#FFF"><?=$descw?></h2><h5 class="titulo_categoria" style="color:#666;"><a href="<?=$modules->js_encode(Category::getLink($v));?>"><?=$modules->js_encode(Category::getName($v));?></a></h5><br><h3 class=titulo_proyecto><a href="<?=$modules->js_encode(Project::getLink($v));?>"><?=$modules->js_encode($v['Project']['title']);?></h3><span class="autor"><?php echo __("by");?><a href="<?=User::getLink($v)?>"><?=$modules->js_encode($v['User']['display_name']);?></a></span><br><p class="texto_destacado"><?=$modules->js_encode($v['Project']['short_description']);?></p><br>	<?= $informacion_proyecto?><!--img src="/2012/images/<!--?=$imgficha?--><!--.png"--><!-- width="288" height="16"--> <?=$button?></div>',
                                <? } ?>
...
<br><br>
<form action="/discover" METHOD="GET" class="buscar_proyectos">
    <div id="filtro">
        <div id="filtro_categorias">
            ...
            <div class="listado_categorias">
                <select autocomplete="off" id="categoria_proyecto1" style="color: #597FA9;" name="data[Project][cat]">
                    <?php
        ...
        <div id="mostrar">
            ...
            <div class="listado_categorias">
                <select autocomplete="off" id="categoria_proyecto2" style="color: #597FA9;" name="data[Project][show]">
                    <?php
        ...
        <div id="ubicacion">
            ...
            <div class="ubicacion_proyecto" id="categoria_proyecto3" >
                ...
                <select style="color: #597FA9;" autocomplete="off"  name="data[Project][paislugar]"  id="ProjectCountryId">
            ...
            <?php
            echo $this->Form->submit('Buscar',array('class' => 'buscar_proyectos', 'title' => 'Custom Title'));
...
?>
 ...
 <div style="position:absolute; width:100%; left:0; overflow: hidden">
...
?>
 ...
 <div style="position:absolute; width:100%; left:0;">
	<a href="/predefined/<?=$v['predefinidos' ]['id']?>/<?=friendlyUrl;?>"><img border="0" src="<?=$img?>"></a>
...
<div class="misc_categoria"></div>
<h3 class=titulo_proyecto><a href="/predefined/<?=$v['predefinidos' ]['id']?>/<?=friendlyUrl($v['predefinidos' ]['title']);?>"><?php if ($_SESSION["idioma"]== "esp"){echo $v['predefinidos']['title'];}else{ echo $v['predefinidos']['title_'.$_SESSION["idioma"]];}?></a></h3>
