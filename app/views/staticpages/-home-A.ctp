...
DR(
   ...
   createSlideHome(
				  ...
				  ?>
					'<div id="foto" style="background:url( <?=$img ?>) center center no-repeat"></div><div id="descripcion"><h2 style="color:#FFF"><?=$descw?></h2><h5 class="titulo_categoria" style="color:#666;"><a href="<?=$modules->js_encode(Category::getLink($v));?>"><?=$modules->js_encode(Category::getName($v));?></a></h5><br><h3 class=titulo_proyecto><?=$modules->js_encode($v['Project']['title']);?></h3><span class="autor">por <a href="<?=User::getLink($v)?>"><?=$modules->js_encode($v['User']['display_name']);?></a></span><br>-<p class="texto_destacado"><?=$modules->js_encode($v['Project']['short_description']);?></p><br>	<table  style="position:relative; display:inline-block" width="200" border="0" align="center" class="tabla_proyectos">	  <tr>    	<td width="71" align="center"><?= Project::getFundedValue($v) ?>%</td>	    <td width="121" align="center"><?= Project::getCollectedValue($v) ?></td>	    <td width="81" align="center"><?= $v['Project']['sponsorships_count']; ?></td>	  </tr>	</table>	<img src="/2012/images/<?=$imgficha?>.png" width="288" height="16"> <?=$button?></div>',
					<? } ?>
...
<div id="banner">
<div id="welcome">
<h1>Bienvenidos a Groofi.com</h1><br>
<p class="subtitle_banner">Groofi naci&oacute; para convertirse en la primera plataforma de financiamiento colectivo global. </p><br>
<p style="font-size:13px">Creemos que la diversidad potencia el talento y la suma de talento atrae al capital. De esa manera groofi esta destinada a convertirse en un puente entre la creatividad y el financiamiento, desatando de esa manera el potencial de todas las personas en el mundo.</p><br>
<div class="boton_crear" onclick="window.location='<?= Router::url (array ('controller' => 'projects', 'action' => 'add'))?>';">HAZ TU PROYECTO!</div>
<div class="boton_how"  onclick="window.location='/como-funciona'">COMO FUNCIONA</div>
  <div class="clear"></div>
</div>
<div id="video_home"><iframe src="http://player.vimeo.com/video/44255570?title=0&amp;byline=0&amp;portrait=0&amp;color=008ed3" width="480" height="270" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  <div class="clear"></div>
<div onclick="setVideoPersonas();" id="pestana_personas_on">PERSONAS</div>
<div onclick="setVideoEmpresas();" id="pestana_empresas_out">EMPRESAS</div>
<div class="clear"></div>
...
<div id="corjurto"> 
	...
	?>
      <div class="thumb"><img onMouseOver="overThumb(this.getAttribute('data-index'),parseInt(this.getAttribute('data-index'))+1,this.getAttribute('data-titulo'))" onclick="clickTn(<?=$i?>)" data-index="<?=$i?>" data-titulo="<?=htmlentities($v['Project']['title'],ENT_QUOTES,'UTF-8');?>" src="<?=$img ?>" width="120" height="120"></div>	
     <? $i++;} ?>
	  <div id="velo"></div>
...
<br>
<h2 class="cyan"> Proyectos Creados </h2>
...
<div id="ubicacion">
<h4  style="cursor:pointer"  class="titulo_footer">UBICACION</h4>
<img  style="cursor:pointer"  class="misc_categorias02" src="/2012/images/misc_categorias02.png" width="19" height="16">
<div class="clear"></div>
<div style="width:2px" class="misc_separador"></div><br>
<div class="listado_ubicaciones">
<ul><a href="/discover/projects"><?php echo __("ALL_CATEGORIES");?></a></ul>
<!--<?php
...
?>
 ...
 <div style="position:absolute; width:100%; left:0;">
  ...
  <img src="/2012/images/bolsa_icon.png" style="position:absolute;right:10px;top:148px">
...
<h2 class="green"> Proyectos predefinidos </h2>
<?php
$clases=array('proyecto_izq','proyecto_centro','proyecto_der');
$i=0;
