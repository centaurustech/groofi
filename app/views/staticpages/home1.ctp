...
<div class="listado_categorias">
    <select autocomplete="off" id="categoria_proyecto" style="color: #597FA9;">
    <?php
...
<ul>
    <option>
        <a href="<? echo Category::getLink($categorias[$i]['categories']);?>"><? echo Category::getName($categorias[$i]['categories']);?></a></ul>
     </option>
<?php } ?>
    </select>
</div>
...
<div class="listado_categorias">
    <select autocomplete="off" id="tipo_proyecto" style="color: #597FA9;">
    <?php
...
<ul>
    ...
    <option><a href="/discover/<?=$k?>/projects"><?= $v; ?></a></option>
...
<div style="width:2px" class="misc_separador"></div><br>
    ...
    <div class="ubicacion_proyecto">
        ...
        <select autocomplete="off"  name="data[Project][paislugar]" autocomplete="off" id="ProjectCountryId" style="color: #597FA9;">
