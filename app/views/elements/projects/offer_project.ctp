...
<div class="box box-project box-profile-project offer_project" id="project_<?= $project['Project']['id'] ?>">
    <?php
    /* @var $this ViewCC */
    if ($project) {
        echo $this->Html->div('thumb', $this->Media->getImage('m156', $project['Project']['image_file'], '/img/assets/img_default_156x104px.png'));
        // info
        ...
        if (Project::isPublic($project)) {
            ...
            <div class="projectStats stats">
                ...
                <? if ($project['Project']['time_left'] > 0) { ?>
