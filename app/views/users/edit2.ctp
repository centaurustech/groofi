...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            equalTo: "<?php __("match");?>",
            maxlength: $.validator.format("Please enter no more than {0} characters."),
            minlength: $.validator.format("<?echo __("minLength_5")?>"),
...
jQuery( document ).ready(function () {
        jQuery('.edit_datos_user').validate({
            rules : {
                "data[User][password]" : {
                    required: true,
                    minlength : 5
                ...
                "data[User][password_confirmation]" : {
                    required: true,
                    minlength : 5,
                    equalTo : "#password_user_editar"
                }
            }
        });

        jQuery('.bot_guardar').click(function(){
            if(jQuery('.edit_datos_user').valid() == true){
                jQuery('#formchangesettings').submit();
...
?>
<form class="edit_datos_user" id="formchangesettings" enctype="multipart/form-data" method="post" action="/settings/profile" accept-charset="utf-8" style="overflow:visible">
...
?>
<div style="font-size: 10px" onclick="location='<?=Router::url (array ('controller' => 'users', 'action' => 'edit', 'tab' => 'profile'))?>';" class="perfil_user"><?php echo __("USER_PROFILE");?></div>
<div style="font-size: 10px" onclick="location='<?=Router::url (array ('controller' => 'users', 'action' => 'edit', 'tab' => 'account'))?>';" class="cuenta_user"><?php echo __("account");?></div>
...
<input id="password_user_editar" type="password" name="data[User][password]" autocomplete="off"  style="width:200px"/>
</div>
...
<div onclick="$('que').disabled=0; " class="bot_guardar"><?php echo __("USER__PROFILE_SAVE");?></div>
