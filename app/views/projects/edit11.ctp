...
<input readonly="true" value="<?if(isset($this->data['Project']['funding_goal'])){echo $this->data['Project']['funding_goal'];}?>" id="in_fondos" type="text" name="data[Project][funding_goal]" /></div>
...
<div class="texto_how_izq">
<p style="display:none;font-size:12px"><?php echo __("PROJECT__PROJECT_DURATION");?></p><br>
<input name="data[Project][project_duration]" type="hidden" autocomplete="off" class="range" value="7" id="ProjectProjectDuration" />
<div style="z-index: 0;position:relative; height:17px; width:360px">
<div id="indicadords" style="display:none;font-size:10px;">7 d&iacute;a/s</div>
<div  class="back_slider" style="display:none;width:360px; height:10px; border:1px solid #eaeaea; position:relative; top:-40px;">
<div id="blueLine" style="display:none;width:0%; height:100%;background:#338abd;"></div>
</div>
<div id="cursor" style="display:none;width:17px; height:17px; border:1px solid #d3d3d3; background:#e6e6e6;cursor:pointer; position:relative; top:-15px;"></div>
</div>


<div style="display: none" class="bot_info duracion" onmouseout="hideTip()"  onmousemove="showTip(event,'<?php echo __("PROJECT__PROJECT_DURATION__HELP_MESSAGE_TEXT");?><br><?php echo __("PROJECT__PROJECT_DURATION__TIP_MESSAGE_TEXT");?>')"></div>
</div>
