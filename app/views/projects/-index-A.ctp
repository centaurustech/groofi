...
<div onclick="location='/projects/add'" class="empezar_proyecto">Quiero empezar mi proyecto</div><img src="/2012/images/info_descubre_proyectos.png" width="958" height="298">
