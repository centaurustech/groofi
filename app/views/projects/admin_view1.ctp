...
<div  style="width:380px;float: right;" class="actions">
    ...
    if (Project::isPublished($project)) {
        ...
        $flags .= $this->Form->input("Project.{$project['Project']['id']}.outstanding", array('label' => 'SHOW_IN_HOMEPAGE', 'type' => 'checkbox', 'checked' => ( $project['Project']['outstanding'] ? true : fal                $flags .=$this->Form->input("Project.{$project['Project']['id']}.leading", array('label' => 'STUDY_CASE', 'type' => 'checkbox', 'checked' => ( $project['Project']['leading'] ? true : false )));
