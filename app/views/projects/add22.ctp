...
<div class="ckeditor0">
    ...
    <div class="ckeditor0">
        ...
        <div class="info_descripcion" onmouseout="hideTip()" onmousemove="showTip(event,'Describe tu proyecto en extenso. Podr&aacute;s editar esta descripci&oacute;n una vez aprobado tu proyecto.<br>Cuanta m&aacute;s informaci&oacute;n pongas y m&aacute;s claro seas en esta descripci&oacute;n, m&aacute;s confiable resultar&aacute; tu proyecto para los patrocinadores.')"></div>
    </div>
