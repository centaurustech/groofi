...
class ProjectsController extends AppController {
    ...
    function beforeFilter () {
        ...
        $this->Auth->allow ('view', 'listing', 'index', 'cron_aboutToFinish', 'cron_Finished','verifyPrivate','edit');
    ...
    function edit ($id = null, $publish=false, $getData = false) {
        ...
        if (empty ($this->data)) {
            ...
            if (empty ($this->data)) {
              ...
              }elseif ($this->data['Project']['enabled'] != 1 && $this->data['Project']['public'] != 0) { // if project exist and don't belongs to an auth user, check if it's editable
                echo ("publicado");
                      $this->pageError = array ('code' => 404);
