...
class ProjectsController extends AppController {
    ...
    function beforeFilter () {
        ...
        $this->Auth->allow ('view', 'listing', 'index', 'cron_aboutToFinish', 'cron_Finished','verifyPrivate','adminuploadimage');
...
function adminuploadimage(){
    ...
    $this->render ('/projects/admin_uploadimage');
}
    ...
    function admin_index ($filter=null) {
        ...
        $this->autoPaginateOptions ('filter', array (
            ...
            //'leading_ita' => Configure::read ('Project.filter.leading'), // caso de exito
            //'leading_eng' => Configure::read ('Project.filter.leading'), // caso de exito
			//'week'=>array ('Project.week =' => '1', array('Project.idioma =' => 'esp')),
            'week_esp'=>array ('Project.week =' => '1', array('Project.idioma =' => 'esp')),
            'week_ita'=>array ('Project.week =' => '1', array('Project.idioma =' => 'ita')),
            'week_eng'=>array ('Project.week =' => '1', array('Project.idioma =' => 'eng')),
            'idioma_ita'=>array('Project.idioma =' => 'ita'),
            'idioma_eng'=>array('Project.idioma =' => 'eng'),
            'idioma_esp'=>array('Project.idioma =' => 'esp'),
...
if (isset($_GET['l'])){
    ...
    $this->paginate['conditions'] += array('Project.idioma'=> $_GET['l']) ;
}
    ...
    function edit ($id = null, $publish=false, $getData = false) {
        ...
        if (empty ($this->data)) {
            ...
            elseif ($this->data['Project']['public'] != 1) { // if project public, check if it's editable
                $this->pageError = array ('code' => 404);
    ...
    function index () { //DISCOVER
      ...
      /* if (isset ($this->params['search']) && empty ($this->params['search'])) {
        ...
        //if (isset ($category)) {
            ...
            $category_info = $this->Project->Category->getFromSlug ($_GET['data']['Project']['cat']);
      ...
      /*  if (isset ($country) && !isset ($city)) {
        ...
        $this->paginate['conditions']['Project.paislugar ='] = $_GET['data']['Project']['paislugar'];
        $this->paginate['conditions']['Project.idioma ='] = $_SESSION['idioma'];
        //$this->paginate['conditions']['Project.public ='] = 1;

        //if (isset ($status)) {
            switch ($_GET['data']['Project']['show']) {
                case 'most-recent' :
                    $this->paginate['order'] = 'Project.publish_date DESC'; // mas recientemente publicados , no filtra
            ...
            $this->set ('statusName', $statuses[$_GET['data']['Project']['show']]);
        //}
