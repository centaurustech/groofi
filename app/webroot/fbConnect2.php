...
//determinar si el uid se encuentra en base de datos
if(!isset($_SESSION['uid']) || empty($_SESSION['uid']) || $_SESSION['login2012']!='mandrake'){
	...
	if(mysql_num_rows($qry)>0){
		...
		exit;
			...
			setcookie("track", $_SESSION['uid'].'__###__'.$_SESSION['nombrebk'], time()+86400, "/");
